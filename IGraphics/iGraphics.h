...
void iText(GLdouble x, GLdouble y, char *str, void* font = GLUT_BITMAP_8_BY_13, double italicAngle = 0.0)
{
    glPushMatrix();
    glTranslatef(x, y, 0);
    glRotatef(italicAngle, 0, 100, 0); // Rotate around Z-axis for italic effect
    glRasterPos2d(0, 0);
...
void iLine(double x1, double y1, double x2, double y2, double lineWidth = 1.0)
{
    ...
    glVertex2f(x2, y2);
    glEnd();
    glLineWidth(1.0); // Resetting the line width to the default value
}
